...
WebUI.sendKeys(findTestObject('Object Repository/OR_Zing/Input_Search'), "abc")
...
for (int i = 0; i < searchResults.size(); i++) {
	...
	assert searchResults[i].getText().toString().contains(GlobalVariable.inputSearchText)
}
